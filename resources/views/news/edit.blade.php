...
@section('content')
    <div class="card">
        <div class="card-header text-center">
            <h3 class="p-2">Editar noticia</h3>
        </div>
        <div class="card-body">
            <form action="{{route('news.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="description" id="richText" required>{{$news->description}}</textarea>
                    </div>
                </div>
                <input type="hidden" name="newsID" value="{{$news->id}}">
                <div class="row">
                    <div class="col-md-12 mt-4 d-flex justify-content-center">
                        <input type="submit" class="btn btn-success" value="Modificar" id="btn-show">
                    </div>
                </div>
            </form>
        </div>
